...
export default function AddStatusModalSmall({ onClose }) {
  ...
  // ─────────────────────────────────────
  return (
    <div className=" md:hidden flex fixed inset-0 z-50 bg-black/80  items-center justify-center p-4">
      <div className="bg-[var(--bg-main)] rounded-2xl w-full max-w-md overflow-hidden">
        ...
        {step === "type" && (
          <div className="p-6 space-y-4">
            <button onClick={startCamera} className="w-full flex items-center gap-4 p-4 bg-[var(--color-primary)] rounded-xl hover:bg-cyan-500/20 transition">
